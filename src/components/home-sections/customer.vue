<template>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 w-10/12 lg:w-11/12 m-auto my-20 ">
        <div class="mt-8 lg:mt-0 h-24 flex grid grid-cols-1 justify-items-center items-center px-4 py-8">
        ...
        <div class="mt-8 lg:mt-0 h-24 grid grid-cols-1 justify-items-center items-center px-4 py-8">
            <p class="text-4xl"><span class="font-bold">+</span> 85</p>
            <p class="mt-3 font-bold uppercase">Work samples</p>
        </div>
        <div class="mt-8 lg:mt-0 h-24 ">
